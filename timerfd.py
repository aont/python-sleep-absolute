...
if sys.platform.startswith("linux"):
    ...
    def _set_timerfd_absolute(fd, target_time: datetime.datetime):
        target_timestamp = target_time.timestamp()
        target_timestamp_modf = math.modf(target_timestamp)
    ...
    class Sleeper:
        ...
        def __init__(self):
            ...
            self._event_wait_fut = asyncio.Future()
            self._loop = None
        ...
        async def _wait_timerfd(self, fd, no_cancel_error):
            ...
            self._event_wait_fut = asyncio.ensure_future(self._event.wait())
            if no_cancel_error:
                try:
        ...
        async def wait_until(self, target_time: datetime.datetime, no_cancel_error: bool = False):
